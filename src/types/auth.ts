...
export const PREDEFINED_PERSONAS: UserPersona[] = [
  {
    ...
    description:
      'Lead Sales Progressor & Case Admin managing branch progression pipelines and milestone signoffs.',
    avatarText: 'SJ',
  ...
  },
  {
    ...
    permissions: [
      ...
      DOMAIN_PERMISSIONS.CASE_CUSTOMIZE,
  ...
  },
  {
    id: 'usr_agent_3',
    name: 'Alex Turner',
    email: 'alex.turner@iceberg-agency.co.uk',
    companyId: 1001,
    branchId: '2',
    roles: ['Sales Negotiator', 'role-negotiator'],
    permissions: [
      DOMAIN_PERMISSIONS.CASE_READ,
      DOMAIN_PERMISSIONS.CASE_CREATE,
      DOMAIN_PERMISSIONS.CASE_CUSTOMIZE,
  ...
  },
  {
    ...
    email: 'victoria.sterling@iceberg-agency.co.uk',
    companyId: 1001,
    roles: ['admin', 'superuser', 'Sales Progressor'],
    permissions: Object.values(DOMAIN_PERMISSIONS),
    description:
      'Agency Operations Principal with multi-branch management and template administration rights.',
    avatarText: 'VS',
    badgeVariant: 'primary',
  },
];
